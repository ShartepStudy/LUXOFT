...
CGamePoleComp::CGamePoleComp( CSeaFightApp & host ) :
   CGamePoleBase( host, GAME_POLE_INTERVAL*3 + GAME_POLE_SIZE*2, GAME_POLE_INTERVAL )
{
...
CGamePoleComp::~CGamePoleComp()
{}

void CGamePoleComp::setShips( )
{
   short x, y;
   bool vertical;
...
char CGamePoleComp::getValue( int x, int y )
{
   ...
   case COMP_SHIP_NON_SHOOTED_CHAR: return SHIP_NON_SHOOTED;   //    в этой €чейке спр€тан корабль
