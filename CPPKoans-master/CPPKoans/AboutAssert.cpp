...
void aboutAssertParameterTypes(){
	...
	expectThat("however, if they are not the same, expected is tried to be cast to the actual type.",3,3);
	expectThat("truncating information when casting to narrower type",3,3);
