========================================================================
    KONSOLENANWENDUNG: CPPKoans-Projektübersicht
========================================================================

Diese CPPKoans-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre CPPKoans-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "CPPKoans.pch und eine 
